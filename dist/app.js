...
angular.module('myApp')
	...
	}]);angular.module('templates-dist', ['../app/components/cookbook/clock.html', '../app/components/cookbook/tablefilter.html', '../app/components/cookbook/tictactoe/tictactoe.html', '../app/components/login.html', '../app/components/login/login.html', '../app/components/ux/login.html', '../app/components/ux/main.html', '../app/components/ux/navbar.html', '../app/components/ux/ngcontext/ngcontext.html', '../app/index-async.html', '../app/index.html']);
...
angular.module("../app/components/cookbook/tablefilter.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("../app/components/cookbook/tablefilter.html",
    ...
    "                                <span class=\"letter-icon\">{{setChar(item.name)}}  </span>\n" +
    "                            </div>\n" +
    "                            {{item.name}}\n" +
    "                        </a>\n" +
    "                    </div>\n" +
    "                    <div class=\"col-xs-6\">\n" +
    "                        <div class=\"progress\">\n" +
    "                            <div class=\"progress-bar progress-bar-success\" role=\"progressbar\" aria-valuenow=\"40\" aria-valuemin=\"0\" aria-valuemax=\"100\" ng-style=\"{{setProgress(item.progress)}}\">\n" +
